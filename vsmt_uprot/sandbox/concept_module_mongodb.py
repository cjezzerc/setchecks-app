...
class ConceptsDict(UserDict):
    ...
    def __init__(self, concepts_db_document=None, sct_version=None):
        self.concepts_db_document=concepts_db_document
        self.sct_version=sct_version  # ignoring in first mongodb trial
                                      # really should protect against changing this and not clearing out all old data
        super().__init__()
