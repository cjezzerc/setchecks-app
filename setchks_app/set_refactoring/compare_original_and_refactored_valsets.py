...
def compare_original_and_refactored_valsets(
    ...
    refactored_membership_analysis=valset_module.ValsetMembershipAnalysis(valset=refactored_valset, concepts=concepts)
    original_membership_analysis=valset_module.ValsetMembershipAnalysis(valset=original_valset, concepts=concepts, global_exclusions=valsets.global_exclusions, stub_out_interaction_matrix_calc=True, verbose=True)
    ...
    print("\nConcepts in original and not in refactored valset: %s" % original_members.difference(refactored_members))
    print("Concepts in refactored and not in original valset: %s" % refactored_members.difference(original_members))

    original_include_clause_strings={clause.clause_string for clause in original_valset.clause_based_rule.clauses if clause.clause_type=="include"}
    original_exclude_clause_strings={clause.clause_string for clause in original_valset.clause_based_rule.clauses if clause.clause_type=="exclude"}

    refactored_include_clause_strings={clause.clause_string for clause in refactored_valset.clause_based_rule.clauses if clause.clause_type=="include"}
    refactored_exclude_clause_strings={clause.clause_string for clause in refactored_valset.clause_based_rule.clauses if clause.clause_type=="exclude"}
