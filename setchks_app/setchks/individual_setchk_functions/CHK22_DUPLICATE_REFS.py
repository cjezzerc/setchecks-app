...
def do_check(setchks_session=None, setchk_results=None):
        ...
        if not mr.blank_row:
            ...
            if concept_id is not None:
                ...
                if cid_entered and i_data_row in duplicated_cid_rows:
                    row_specific_message = ", ".join(
                        f"Row {x+1+setchks_session.first_data_row}"
                    ...
                    check_item.row_specific_message = f"{row_specific_message}"
                    # </check_item>
                    ...
                    check_item.outcome_level = "ISSUE"
                    check_item.general_message = "This Description Id is duplicated in this input file, on row(s)-->"
                    check_item.row_specific_message = f"{row_specific_message}"
                    # </check_item>
                    this_row_analysis.append(check_item)
                else:
                    ...
                    check_item.general_message = "No duplication issue found"
                    # </check_item>
                    this_row_analysis.append(check_item)
            else:
    ...
    if (n_DUPLICATE_CIDS + n_DUPLICATE_DIDS) == 0:
        ...
        setchk_results.set_level_table_rows.append(
            SetLevelTableRow(
                descriptor=("Number of duplicate Concept Ids"),
        ...
        setchk_results.set_level_table_rows.append(
            SetLevelTableRow(
                descriptor=("Number of duplicate Description Ids"),
