...
def do_check(setchks_session=None, setchk_results=None):
    ...
    for mr in setchks_session.marshalled_rows:
        ...
        setchk_results.row_analysis.append(
            this_row_analysis
        )  # when this_row_analysis updated below,
        if not mr.blank_row:
        ...
        if mr.excel_corruption_suspected and mr.possible_reconstructed_C_Id is not None:
            ...
            check_item.row_specific_message = termbrowser_hyperlink(
                mr.possible_reconstructed_C_Id
            )
            # </check_item>
            this_row_analysis.append(check_item)
            ...
            check_item.row_specific_message = concepts[
                mr.possible_reconstructed_C_Id
            ].pt
            # </check_item>
            this_row_analysis.append(check_item)
        ...
        if mr.excel_corruption_suspected and mr.possible_reconstructed_D_Id is not None:
            ...
            check_item.row_specific_message = termbrowser_hyperlink(
                mr.possible_reconstructed_D_Id
            )
            # </check_item>
            this_row_analysis.append(check_item)
    ...
    setchk_results.set_level_table_rows.append(
        SetLevelTableRow(
            descriptor=("Total number of rows in the input file"),
    ...
    setchk_results.set_level_table_rows.append(
        SetLevelTableRow(
            descriptor=("Number of rows assessed in the input file"),
    ...
    # <set_level_count>
    setchk_results.set_level_table_rows.append(
        SetLevelTableRow(descriptor=(""), value="", outcome_code="CHK20-OUT-DIVIDER")
    )
    # </set_level_count>
    ...
    if n_OUTCOME_ROWS != 0:
        ...
        setchk_results.set_level_table_rows.append(
            SetLevelTableRow(
                descriptor=("Number of conforming rows"),
        ...
        setchk_results.set_level_table_rows.append(
            SetLevelTableRow(
                descriptor=("Number of non-conforming rows"),
        ...
        setchk_results.set_level_table_rows.append(
            SetLevelTableRow(
                simple_message=(f"[GREEN] This check has detected no issues."),
