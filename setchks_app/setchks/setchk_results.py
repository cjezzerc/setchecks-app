class SetchkResults:
    ...
    def __init__(self):
        ...
        self.row_analysis = []
        self.set_analysis = {}
        self.set_analysis["Messages"] = (
            []
        )  # this can be removed once eradicate this type of message
        ...
        self.chk_specific_data = (
            {}
        )  # this for special cases such as storing refactored_valset in CHK10
